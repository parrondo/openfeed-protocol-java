...
/**
 * Andrei FIXME symbology should not be part of open-feed.
 **/
public class InstrumentUtil {

	// public static Month getMonth(final int monthOfYear) {
	// switch (monthOfYear) {
	// case 1:
	...
	// default:
	// throw new IllegalArgumentException("Illegal monthOfYear: "
	// + monthOfYear);
	//
	// }
	// }

	// public static int getMonthOfYear(final Month month) {
	// switch (month) {
	// case JANUARY_MONTH:
	// return 1;
	// case FEBRUARY_MONTH:
	...
	// public static String getMonthCode(final Month month) {
	// switch (month) {
	// case JANUARY_MONTH:
	// return "F";
	// case FEBRUARY_MONTH:
